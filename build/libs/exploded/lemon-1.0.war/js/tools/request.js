...
window.BaseRequest = (function () {
    ...
    request.post_password_form_data = function (param,url,callback,paramType,formData,opt_error) {
        var form_data = new FormData();
        if(formData && formData=='formdata'){
            $.each(param.inputData,function(i,item){
                form_data.append(i,item);
            ...
            form_data.append('modifyPasswordBean', new Blob([JSON.stringify(param.inputData)], {
                type: "application/json"
            }));
            form_data.append('smsValidateBean', new Blob([JSON.stringify(param.inputData)], {
                type: "application/json"
            }));
        }
        baseRequestFunc('post',form_data,url,true,false,'json',false,callback,paramType,opt_error);
